...
@Component({
  selector: 'operator-accept-offer-dialog',
...
export class AcceptOfferDialogComponent {
  ...
  @ViewChild(components.AcceptOfferFormComponent)
  private acceptOfferFormComponent: components.AcceptOfferFormComponent;
