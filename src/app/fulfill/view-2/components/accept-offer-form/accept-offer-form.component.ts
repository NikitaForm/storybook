...
@Component({
  selector: 'operator-accept-offer-form-2',
  templateUrl: './accept-offer-form.component.html',
  styleUrls: ['./accept-offer-form.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class AcceptOfferForm2Component extends sharedComponents.ValidatableFormComponent implements OnChanges, OnInit, OnDestroy {
