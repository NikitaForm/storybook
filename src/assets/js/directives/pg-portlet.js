    ...
    .directive('pgPortlet', ['$parse', function($parse) {
        return {
            ...
            link: function(scope, element, attrs) {
                ...
                // var asyncTaskOnStart = function() {
                //     $(el.find('div[pg-portlet]:first')).portlet({
                //         refresh: true
                //     });
                // };
                //
                // var asyncTaskOnFinish = function() {
                //     $(el.find('div[pg-portlet]:first')).portlet({
                //         refresh: false
                //     });
                // };
                //
                // scope.asyncTaskOnStart = asyncTaskOnStart;
                // scope.asyncTaskOnFinish = asyncTaskOnFinish;
            }
        }
    }]);