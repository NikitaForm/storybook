  ...
  decorators: [
    moduleMetadata({
      declarations: [OrderFormComponent, AircraftListComponent, MainScreenComponent, AircraftFormComponent, ImageUploadComponent,
        AircraftFormV2Component, EnumToArrayPipe, PriceTypePipe, ConfirmationDialogComponent],
      imports: [CommonModule, GridModule, AppRoutingModule, LayoutModule,
        ...
        DropDownsModule, TextMaskModule, SharedModule, TimePickerModule, DialogModule],
      providers: [
